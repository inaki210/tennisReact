...
export class Main {
    ...
    private imprimirResultado() {
        if (this.juego1 != null) {
            ...
            (document.getElementById("divResultados") as HTMLElement).innerHTML = this.resultadoCadena;
    ...
    public iniciar(action:string) {
        ...
        if (accion == "jugar") {
            ...
            (document.getElementById("btnPlay") as HTMLElement).classList.add("display-none");
            (document.getElementById("btnNew") as HTMLElement).classList.remove("display-none");
        }
            ...
            (document.getElementById("btnNew") as HTMLElement).classList.add("display-none");
            (document.getElementById("btnPlay") as HTMLElement).classList.remove("display-none");
        }
    }    
}
export default Main;
